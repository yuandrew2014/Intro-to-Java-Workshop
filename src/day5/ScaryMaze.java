...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		//10. if the mouse is on the end color
			if (mouseX > 446 && mouseX < 457 && mouseY > 353 && mouseY < 363 ) {	
	JOptionPane.showInternalMessageDialog(null, "you have beaten the dabing, scary maze");
			}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("381780__darkmime__ascending-jumpscare.wav"));
		sound.play();
